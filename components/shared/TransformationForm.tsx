...
import { CustomField } from "./CustomFied"
...
import InsuffiecientCreditsModal from "./InsuffiecientCreditsModal"
    ...
    <div>
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}
          className="space-y-8">
          {creditBalance < Math.abs(creditFee) && <InsuffiecientCreditsModal />}
          <CustomField
